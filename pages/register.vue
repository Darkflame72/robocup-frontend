          ...
          <ValidationObserver v-slot="{ invalid }" immediate>
            <form class="mt-8 space-y-6" @submit.prevent="submit">
                  ...
                  <ValidationProvider v-slot="{ failedRules }" rules="email">
                    ...
                    >
                      ...
                      <input
                        ...
                        autocomplete="email"
                        required
                        class="w-full px-3 py-2 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-green-500 focus:border-green-500 focus:z-10 sm:text-sm"
              ...
              <div class="text-sm text-right">
                <a
                  href="#"
                  class="font-medium text-right text-green-600 hover:text-green-500"
